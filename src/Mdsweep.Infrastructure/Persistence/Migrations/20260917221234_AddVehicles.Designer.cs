...
namespace Mdsweep.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260917221234_AddVehicles")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Mdsweep.Domain.Vehicles.VehicleAggregate", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<string>("Make").HasMaxLength(100).HasColumnType("character varying(100)").HasColumnName("make");
                    b.Property<string>("Model").HasMaxLength(100).HasColumnType("character varying(100)").HasColumnName("model");
                    ...
                    b.HasIndex("TenantId", "Vin")
                        .IsUnique()
                        .HasDatabaseName("ix_vehicles_tenant_id_vin");
